package pr.tongson.lib_swipeback.swipebacklayout;
...
import pr.tongson.lib_swipeback.R;
...
class BGASwipeBackShadowView extends FrameLayout {
    ...
    private Bitmap getBitmap(View view) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(view.getDrawingCache(), 0, 0, UIUtil.getRealScreenWidth(mActivity), UIUtil.getRealScreenHeight(mActivity) - UIUtil.getNavigationBarHeight(mActivity));
