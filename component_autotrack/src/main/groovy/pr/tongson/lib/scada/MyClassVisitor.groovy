...
class MyClassVisitor extends ClassVisitor {
    ...
    private HashMap<String, MyMethodCell> mLambdaMethodCells = new HashMap<>()
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        methodVisitor = new MyDefaultMethodVisitor(methodVisitor, access, name, desc) {
            ...
            void visitInvokeDynamicInsn(String name1, String desc1, Handle bsm, Object... bsmArgs) {
                ...
                try {
                    ...
                    MyMethodCell myMethodCell = MyHookConfig.LAMBDA_METHODS.get(Type.getReturnType(desc1).getDescriptor() + name1 + desc2)
                    if (myMethodCell != null) {
                        Handle it = (Handle) bsmArgs[1]
                        mLambdaMethodCells.put(it.name + it.desc, myMethodCell)
                    }
                } catch (Exception e) {
                    e.printStackTrace()
                }
            ...
            protected void onMethodEnter() {
                 ...
                 */
                MyMethodCell lambdaMethodCell = mLambdaMethodCells.get(nameDesc)
                if (lambdaMethodCell != null) {
                    ...
                    boolean isStaticMethod = MyUtils.isStatic(access)
                    if (!isStaticMethod) {
