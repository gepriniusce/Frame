...
public class NewMessageNotification {
    ...
    public static void notify(final Context context, final String exampleString, final int number) {
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context,"tongson.channelId")
                ...
                // later.
                .setStyle(new NotificationCompat.BigTextStyle().bigText(text).setBigContentTitle(title).setSummaryText("Dummy summary text"))
